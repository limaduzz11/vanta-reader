...
/// Card Especializado para Histórias em Quadrinhos e Mangás (Aspect Ratio 3:4)
class NovaComicCard extends StatelessWidget {
  final Work work;
  ...
  Widget build(BuildContext context) {
    Widget coverContainer = AspectRatio(
      aspectRatio: NovaDimensions.comicCoverAspectRatio,
      child: Container(
    ...
    final progressLabel = (progress != null && progress! > 0)
        ...
        : '';
    final volLabel = work.volume != null ? ' Volume ${work.volume}. ' : '';
    ...
    Widget card = Semantics(
      ...
      enabled: onTap != null,
      label:
          '${work.title}, de ${work.author}.$volLabel Formato $formatLabel.$progressLabel$downloadedLabel',
      child: InkWell(
        onTap: onTap,
        borderRadius: NovaShapes.roundedMd,
